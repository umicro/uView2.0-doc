<template>
  <div class="row friend-link">
    ...
    <div class="col-md-2 col-sm-2 col-xs-4 friend-link__wrap">
      <a target="_blank" class="friend-link__wrap__item"
         href="http://chu1204505056.gitee.io/admin-pro/?hmsr=uview&hmpl=&hmcu=&hmkw=&hmci=">
        <img src="/friend-link/vue-admin-beautiful.png">
      </a>
    </div>
    <div class="col-md-2 col-sm-2 col-xs-4 friend-link__wrap">
      <a target="_blank" class="friend-link__wrap__item" href="https://github.com/livelyPeng/pl-table">
    ...
    <div class="col-md-2 col-sm-2 col-xs-4 friend-link__wrap">
      <a target="_blank" class="friend-link__wrap__item" href="https://majiang.co">
        <img src="https://vkceyugu.cdn.bspapp.com/VKCEYUGU-8f7e1d02-dcb1-46ba-90db-ae32fea44f22/d50b8253-2866-49f0-89ba-b2cb68cef42d.png">
      </a>
    </div>
  </div>
</template>
